...
class SolanaConfig {
  ...
  static const String programId =
      '3JD2GSJBLPYwwHLmBzh5MRpDZp2eh4KukzHvR8CvmcAc';

  /// Deployment transaction signature (for verification)
  static const String deploymentSignature =
      'qUCYitjUmixJS17MwKUjQdxG5nztTkDWmgfQ8a2NjEsTtFyxCxb5dMPYA';
  ...
  static const String backendApiUrl =
      'http://10.0.2.2:3001'; // Default fallback
