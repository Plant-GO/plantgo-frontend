...
class AppColors {
  ...
  static const Color darkBlue1 = Color(0xFF141F23);
  static const Color darkBlue2 = Color(0xFF202F36);
  static const Color background = Color(0xFF0E1217);

  // Theme specific
  static const Color primary = featherGreen;
  static const Color accent = macaw;
  static const Color textLight = polar;
  static const Color textDark = eel;
  static const Color iconDefault = wolf;
  static const Color iconActive = primary;
  static const Color bottomNavBackground = Color(0xFF233428);
  
  // Success, Warning, Error colors
  static const Color success = maskGreen;
