...
/// Login screen with email/password and guest option
...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _login() async {
    ...
    try {
      final appUser = await _authService.loginWithEmail(
      ...
      if (mounted) {
        ...
        userProvider.setEmail(appUser.email);
        userProvider.setIsGuest(false);
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Sign in to continue your plant adventure',
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: _navigateToGuestLogin,
